...
- Name: auth.spec.ts >> Authentication Flows >> Caso 2: Login con credenciales inválidas muestra error
...
Locator: locator('div.text-red-500')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('div.text-red-500')
