    ...
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-slate-50 rounded-xl p-5 text-center border border-slate-200">
          ...
          <p className="text-sm text-slate-500 mt-1">{t("resultTotal")}</p>
        </div>
          ...
          <div className="overflow-x-auto max-h-64 overflow-y-auto">
            <table className="w-full text-xs">
              <thead className="text-amber-700 uppercase">
                <tr>
                  <th className="py-1 pr-4 text-left">{t("resultColRow")}</th>
                  <th className="py-1 text-left">{t("resultColError")}</th>
                </tr>
              </thead>
      ...
      <button onClick={onReset} className="w-full py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition-colors">
        {t("newImport")}
      </button>
    </div>
  );
