    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-bold text-slate-800 mb-2">{t("pdfTitle")}</h2>
          <p className="text-sm text-slate-500 mb-6 flex-1">{t("pdfDesc")}</p>
          <a
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-bold text-slate-800 mb-2">{t("excelTitle")}</h2>
          <p className="text-sm text-slate-500 mb-6 flex-1">{t("excelDesc")}</p>
          <a
